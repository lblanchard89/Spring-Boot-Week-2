...
public class ProductController {
	...
	public ResponseEntity<Object> createdProduct(@RequestBody Product product) {
		return new ResponseEntity<Object>(service.createProduct(product), HttpStatus.CREATED);
	}
	
	@RequestMapping(value="/{id}", method=RequestMethod.PUT)
	public ResponseEntity<Object> createProduct(@RequestBody Product product, @PathVariable Long id) {
		try {
